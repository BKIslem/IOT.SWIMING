        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li class=""><a href="?coach=home"><i class="fa fa-home"></i> Home</span></a></li>
                    <li class=""><a href="?coach=user&id=<?= $_SESSION['id'] ?>"><i class="fa fa-home"></i> Training Tracking</span></a></li>
                    <li class=""><a href="?coach=training&id=<?= $_SESSION['id'] ?>"><i class="fa fa-home"></i> Training Modification</span></a></li>
                </ul>
            </div>
