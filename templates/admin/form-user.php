<?php
$coachs = $general->allCoach();
$bloc = $general->allBloc();
$data = null;
if(isset($_GET['id']) && $_GET['id']){
    $data = $general->getUser($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br>
                                <form class="form" method="post" action="?admin=actionUser" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group item">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align">Select Coach <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <select required class="select2_single form-control" tabindex="-1" coach>
                                                <option></option>
                                                <?php  foreach($coachs as $row) { ?>
                                                    <option value="<?= $row['id'] ?>" <?= (isset($data['id_coach']) && $data['id_coach'] == $row['id'] )? 'selected' : '' ?>> <?= $row['first_name'] ?> <?= $row['last_name'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
