            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Add and delete Coech from the list</small>
                            </h2>
                        ...
                        <div class="x_content">
                            <div class="row">
                                <div class="col-sm-12" style="text-align: right">
                                    <a href="?admin=formCoach" class="btn btn-primary" style="text-align: right">ADD</a>
                                </div>
                                <div class="col-sm-12">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered"
                                            ...
                                            foreach($coachs as $row) {
                                                ...
                                                <tr>
													...
													<td><?= $row['gender'] ?></td>
													<td><a href="?admin=formCoach&id=<?= $row['id'] ?>" class="btn btn-warning">
														<i class="fa fa-edit"></i> Edit
														</a>
														<a href="?admin=deleteCoach&id=<?= $row['id'] ?>" class="btn btn-danger">
